...
public static class OfficeScheduleMapper
{
    ...
    public static OfficeScheduleGetAllDto MapToOfficeScheduleGetAllDto(this Office office)
        => new()
        {
            ...
            Schedules        = office.OfficeSchedules.Select(officeSchedule => officeSchedule.MapToScheduleDto())
    ...
    [Decompile]
    public static OfficeScheduleDto MapToScheduleDto(this OfficeSchedule officeSchedule)
        => new()
        {
            WeekDayId   = officeSchedule.WeekDayId,
            WeekDayName = officeSchedule.WeekDay.Name,
            Schedule    = officeSchedule.StartHour.GetHourWithoutSeconds() + " - " + officeSchedule.EndHour.GetHourWithoutSeconds()
        };
}
